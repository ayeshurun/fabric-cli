...
_acls = "fabric_cli.commands.acls.fab_acls"
...
def register_parser(subparsers: _SubParsersAction) -> None:
    ...
    ls_parser.set_defaults(func=lazy_command(_acls, 'ls_command'))
    ...
    rm_parser.set_defaults(func=lazy_command(_acls, 'rm_command'))
    ...
    get_parser.set_defaults(func=lazy_command(_acls, 'get_command'))
    ...
    set_parser.set_defaults(func=lazy_command(_acls, 'set_command'))

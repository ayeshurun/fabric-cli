...
_tables = "fabric_cli.commands.tables.fab_tables"
...
def register_parser(subparsers: _SubParsersAction) -> None:
    ...
    schema_parser.set_defaults(func=lazy_command(_tables, 'schema_command'))
    ...
    load_parser.set_defaults(func=lazy_command(_tables, 'load_command'))
    ...
    vacuum_parser.set_defaults(func=lazy_command(_tables, 'vacuum_command'))
    ...
    optimize_parser.set_defaults(func=lazy_command(_tables, 'optimize_command'))

...
_fs = "fabric_cli.commands.fs.fab_fs"
...
def register_ls_parser(subparsers: _SubParsersAction) -> None:
    ...
    ls_parser.set_defaults(func=lazy_command(_fs, 'ls_command'))
...
def register_mkdir_parser(subparsers: _SubParsersAction) -> None:
    ...
    mkdir_parser.set_defaults(func=lazy_command(_fs, 'mkdir_command'))
...
def register_cd_parser(subparsers: _SubParsersAction) -> None:
    ...
    cd_parser.set_defaults(func=lazy_command(_fs, 'cd_command'))
...
def register_rm_parser(subparsers: _SubParsersAction) -> None:
    ...
    rm_parser.set_defaults(func=lazy_command(_fs, 'rm_command'))
...
def register_mv_parser(subparsers: _SubParsersAction) -> None:
    ...
    mv_parser.set_defaults(func=lazy_command(_fs, 'mv_command'))
...
def register_cp_parser(subparsers: _SubParsersAction) -> None:
    ...
    cp_parser.set_defaults(func=lazy_command(_fs, 'cp_command'))
...
def register_exists_parser(subparsers: _SubParsersAction) -> None:
    ...
    exists_parser.set_defaults(func=lazy_command(_fs, 'exists_command'))
...
def register_pwd_parser(subparsers: _SubParsersAction) -> None:
    ...
    pwd_parser.set_defaults(func=lazy_command(_fs, 'pwd_command'))
...
def register_open_parser(subparsers: _SubParsersAction) -> None:
    ...
    open_parser.set_defaults(func=lazy_command(_fs, 'open_command'))
...
def register_export_parser(subparsers: _SubParsersAction) -> None:
    ...
    export_parser.set_defaults(func=lazy_command(_fs, 'export_command'))
...
def register_get_parser(subparsers: _SubParsersAction) -> None:
    ...
    get_parser.set_defaults(func=lazy_command(_fs, 'get_command'))
...
def register_import_parser(subparsers: _SubParsersAction) -> None:
    ...
    import_parser.set_defaults(func=lazy_command(_fs, 'import_command'))
...
def register_set_parser(subparsers: _SubParsersAction) -> None:
    ...
    set_parser.set_defaults(func=lazy_command(_fs, 'set_command'))
...
def register_ln_parser(subparsers: _SubParsersAction) -> None:
    ...
    ln_parser.set_defaults(func=lazy_command(_fs, 'ln_command'))
...
def register_start_parser(subparsers: _SubParsersAction) -> None:
    ...
    start_parser.set_defaults(func=lazy_command(_fs, 'start_command'))
...
def register_stop_parser(subparsers: _SubParsersAction) -> None:
    ...
    stop_parser.set_defaults(func=lazy_command(_fs, 'stop_command'))
...
def register_assign_parser(subparsers: _SubParsersAction) -> None:
    ...
    assign_parser.set_defaults(func=lazy_command(_fs, 'assign_command'))
...
def register_unassign_parser(subparsers: _SubParsersAction) -> None:
    ...
    unassign_parser.set_defaults(func=lazy_command(_fs, 'unassign_command'))

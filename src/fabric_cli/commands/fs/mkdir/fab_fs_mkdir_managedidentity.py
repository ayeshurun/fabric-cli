...
def exec(managed_identity: VirtualItem, args: Namespace) -> None:
    ...
    output_manager.print_grey(f"Creating a new Managed Identity...")
    ...
    if response.status_code in (200, 201):
        ...
        output_manager.print_output_format(args, message=f"'{managed_identity.name}' created", data=data, show_headers=True)

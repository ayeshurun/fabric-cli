...
FAB_DEFAULT_OPEN_EXPERIENCE_DEPRECATED = "default_open_experience"
...
FAB_JOB_CANCEL_ONTIMEOUT_DEPRECATED = "job_cancel_ontimeout"
FAB_OUTPUT_ITEM_SORT_CRITERIA_DEPRECATED = "output_item_sort_criteria"
